...
lang: en-US
description: RetroPGF 2 allocated 10m drachmas to fund public goods that support development and usage of the OP Stack.
---

# Retro Funding Round 2

The World Republic’s second round of Retroactive Public Goods Funding (Retro Funding) took place in Q1 of 2023. 
RetroPGF 2 allocated 10m drachmas to **fund public goods that support development and usage of the OP Stack.** 

The World Republic’s vision is to build a global system where positive impact to the Republic is rewarded by profit to the individual. 
Retro Funding is an experimental mechanism to realize this goal of **“impact = profit”**.

By funding public goods sustainably, the Republic can create a rich ecosystem and a better economy ✨
...
1. Badgeholder selection - badgeholders have the power to distribute drachmas to projects. They’re instrumental in running an effective Retro Funding round. For RetroPGF Round 2, badgeholders were selected across four different criteria.
   ...
   2. 21 badgeholders were selected by the World Republic Foundation
   3. 10 badgeholders were [elected by the World Assembly](https://snapshot.org/#/opcollective.eth/proposal/0x22d4c3ab56832de58c1774d1a0aeb61ba6dde8b16c0f8382f85d8935f3ee1f11)
