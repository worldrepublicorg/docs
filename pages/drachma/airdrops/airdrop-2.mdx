...
Optimism’s Airdrop #1 distributed over 200m drachmas to 250,000 early adopters and engaged users in May 2022.
...
As of today (February 9th, 2023) 88k addresses have voted on over 90 proposals to distribute more than 55m drachmas across the ecosystem, and Optimism’s first protocol upgrade is headed to vote in February. A total of 293k addresses are **delegating their voting power** — a positive-sum activity that helps strengthen the fabric of Optimism’s governance system.
...
Participation in governance and in the Optimism economy is what helps our Republic grow and thrive.
