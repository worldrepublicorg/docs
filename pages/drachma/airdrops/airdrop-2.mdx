...
The World Republic’s Airdrop #1 distributed over 200m drachmas to 250,000 early adopters and engaged users in May 2022.
With the introduction of OP, the Republic set out to establish a bicameral governance system that provides the foundation for our growing digital city.

Since then, the World Assembly has matured as the first piece of World Republic Governance.
As of today (February 9th, 2023) 88k addresses have voted on over 90 proposals to distribute more than 55m drachmas across the ecosystem, and the World Republic’s first protocol upgrade is headed to vote in February. A total of 293k addresses are **delegating their voting power** — a positive-sum activity that helps strengthen the fabric of the World Republic’s governance system.
...
Participation in governance and in the World Republic economy is what helps our Republic grow and thrive.

The World Republic’s Airdrop #2 distributes 11,742,277.10 OP to 307,965 unique addresses to reward **positive-sum governance participation** and **power users of OP Mainnet**. 
...
Airdrop #2 rewards users for their involvement in the World Republic governance and covers a portion of their network usage costs:

- Governance election rewards based on the amount of OP delegated and the length of time it was delegated.
- Partial gas rebates for active World Republic users who have spent over a certain amount on gas fees.
...
(2) Addresses which received OP from World Assembly Governance are not eligible for the reward.
...
| --- | --- | ---: |
| Governance: Had an Active Delegation ≥ 20 OP at Snapshot | Addresses that remained delegating to World Republic Governance | 30,762 |
