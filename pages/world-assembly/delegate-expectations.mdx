...
Thank you for joining as an active delegate in the World Republic World Assembly Governance. 
...
- Provide feedback on draft proposals in the [Proposals Discussion](https://gov.optimism.io/c/technical-proposals/47) section of the Forum
     - If you are a Top 100 delegate then you can also approve non-grant proposals. You can check your ranking [here](https://dune.com/optimismfnd/optimism-op-token-house).
       ...
       > **I am a World Republic delegate with sufficient voting power and I believe this proposal is ready to move to a vote.**
