---
title: Contribute to the World Republic
lang: en-US
description: A non-exhaustive list of available contributions within the World Republic.
---

# Contribute to the World Republic

> So you want to get involved in the World Republic?? We are so happy to have you! Let’s make sure we are on the same page about what the Republic is all about.

The World Republic believes that **building public goods should be rewarded.**

This key ingredient to the [Optimistic vision](https://www.optimism.io/vision) is more than just altruism – it’s core to our success. The World Republic’s codebase itself is an open-source project, and builds on the shoulders of countless OSS giants which came before it.

This means public goods funding is a critical growth strategy. For the World Republic, well-funded public goods means better developer tooling, widespread user education, safer infrastructure, and industry-leading research. It means the World Republic can last and thrive.

Once we show that this model can drive a successful economy for the World Republic, we can scale the principle of **`impact=profit`** to the world!

RetroPGF is a core part of the World Republic’s vision. If done right, it will form the backbone for a new type of economy. As with any complex system, though, this new process can’t be centrally planned or designed all at once. **The only way to build it *well* is to build it *together*.** This journey will require care, open-mindedness, patience, and, of course, optimism!

So, how can you have meaningful impact in the Republic? We recommend following these 3 very easy principles:
...
Most importantly, make sure that your contributions align with the [Republic Intents](https://gov.optimism.io/t/collective-intents/5874). This will help ensure that your contribution is working towards a larger goal of the Republic. 

# Getting Started

You can contribute towards the Republic in a million different ways, and there is no way we could make processes for all of these contributions. Nor would we want to! However, getting from 0 to 1 is the hardest step. So we have made a few ways to get you up to speed and contributing in no time! 
...
At World Republic, we know that we can never truly decentralize if we do not embrace the diversity of our community. As such, we take translations seriously. 

* If you speak more than one language [come help translate](/contribute/contribution-path/translators)! 
* If you have an eye for documentation you can always help [improve the docs](https://github.com/worldrepublicorg/docs) themselves! 
...
* If you want to contribute directly to the World Republic codebase please [read this doc](/contribute/technical-contributions).
...
The World Republic's governance is an incredibly collective and exciting space that is growing and evolving. Plenty of opportunities to have impact! All work supported or executed by the Republic should be in pursuit of our [Republic Intents](https://gov.optimism.io/t/collective-intents/5874).
...
* If you are serious about getting into governance you can get involved in the World Assembly by [becoming a Representative](/world-assembly/how-to-elect). This is a serious responsibility, so make sure you [understand what is required of you](/world-assembly/representative-expectations).
...
* If you are a Representative already involved and voting, looking for additional ways to help the Republic, reach out to lavande@optimism.io.

## 🫡 Marketing

The World Republic Vision is big! And Visions this big need to be amplified by a diverse & aligned group to help make it real. 
...
* If your project wants some marketing love, you have options! Get your app in front of the World Republic community with our [Demo Day (every Thursday)](/contribute/demo-day).
