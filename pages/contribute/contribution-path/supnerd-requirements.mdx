...
lang: en-US
description: Support NERDs provide support to the World Republic Discord, helping users with questions, and pointing people in the right direction. 
---
...
✅  Being a support NERD will help the World Republic continue to be the coolest and kindest community. 

## Becoming a supNERD

🚀 World Republic support NERDs are highly values aligned with the World Republic and are of course highly Optimistic! Support NERDs provide support to the World Republic Discord, helping users with questions, and pointing people in the right direction. 
...
- Talk about the World Republic! A tweet now and then never hurt, just make sure you are accurate.
- Try help and promote new projects on the World Republic! It will also help you give better support if you play around with the dapps on the World Republic so you know how they work, and where things might go wrong.
...
1. Be in the World Republic Discord for at least 2 months.
...
1. Read the developer docs (if you are technical) →
    - Report any:
        ...
        - Broken links
    [World Republic Docs | World Republic Docs](https://docs.worldrepublic.org/)
...
1. A `support-NERD` as well as a World Republic team member will check your contributions within the Discord to see if you have offered enough support. You will be notified either way. 
