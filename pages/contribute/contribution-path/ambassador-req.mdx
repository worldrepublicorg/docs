...
lang: en-US
description: Ambassadors create educational content within the World Republic.
---
...
✅  Ambassadors will help onboard millions of users into the World Republic ecosystem through education.
...
🚀 World Republic Ambassadors are highly values aligned with the World Republic and are of course highly Optimistic!
...
* World Republic Ambassadors love to collaborate and help others grow in the Ambassador program.
* World Republic Ambassadors create values-focused content which form the narrative of the entire ecosystem.
* World Republic Ambassadors value sustainability initiatives like [retroactive public goods funding](https://app.optimism.io/retropgf).
...
1. To show your interest, get the `wannabe-ambassador` role in the [#become-an-ambassador](https://discord.com/channels/667044843901681675/973588280715141192) Discord channel. 
    1. **Get Up To Speed:**
        ...
        - Review upvoted Reddit posts in the [r/worldrepublic](https://www.reddit.com/r/worldrepublic/)
    2. **Stay Active - Activity on Reddit in the [r/worldrepublic](https://www.reddit.com/r/worldrepublic/) will be a determining factor for the `ambassador-in-training` role** 
...
- ***Ambassadors vote on your new role by reviewing your contributions:**
    ...
    2. **#2 Content Submission:** Create an original piece of content explaining what [Retroactive Public Goods Funding](https://app.optimism.io/retropgf) is and how it fits into the World Republic’s [Vision](https://www.optimism.io/vision). 
        1. Example Content Title: What is Retroactive Public Goods Funding?
        2. Example Outline:
            1. Set the stage by explaining the [World Republic](https://app.optimism.io/announcement) and its north star: impact=profit
            2. Explain the importance of public goods within a digital society 
                1. Public goods act as a fuel for the growth of the Republic's economy. Growth yields profit for the Republic and profit which funds more investment in public goods, altogether producing a virtuous cycle of impact-driven expansion.
            3. Then get into how the World Republic approaches funding these very important public goods (Retro-PGF)
...
1. **Ambassadors vote on your new role by reviewing your contributions:**
    ...
    2. **Collaborative** **Content Submission:** Create an original piece of content with another `wannabe-ambassador`, `ambassador-in-training` or `ambassador` This can also be a group (3+ creators)
        ...
        2. This collaborative piece of original content can be chosen from the list below. Creators must understand the subject matter cannot use previous content they have created
            1. Any recent World Republic announcement or release (2 months back)
            2. Retroactive Public Goods Funding [https://app.optimism.io/retropgf](https://app.optimism.io/retropgf) 
            3. Explain the World Republic Vision: [https://www.optimism.io/vision](https://www.optimism.io/vision)    
            ...
            5. What is the World Republic? [https://docs.worldrepublic.org/docs/governance/](https://docs.worldrepublic.org/docs/governance/)
...
- **NO PRICE DISCUSSION,** EVER!! This includes speculating about price, moon references, etc. This applies for all projects and not just the drachma. Focus on impact, not profit. 
...
- Content thoroughly explains the subject and makes a deeper connection to the World Republic’s values and or has connected it to the World Republic’s larger vision.
- Content is accurate
...
- Hint: Every single prompt is connected in one or many ways to every other prompt. When you start to make those connections, you begin to realize just how grand of a vision the World Republic has and why the World Republic’s Ambassadors are the best of the best.
...
::: warning NOTICE
⚠️ **Being a World Republic Ambassador is a privilege. If you abuse the power and reputation that comes with being in such an elite group you will lose the privilege.**
::: 

1. **Scamming your follower base →** Example: pump and dump schemes, whether World Republic related or not. Your followers are not exit liquidity. 
