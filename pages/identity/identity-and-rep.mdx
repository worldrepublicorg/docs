...
lang: en-US
description: This document intends to open-source the World Republic Foundation’s thinking around identity and reputation within the Republic, as it relates to Citizenship.
---

# Identity and Reputation

This document intends to open-source the World Republic Foundation’s thinking around identity and reputation within the Republic, as it relates to Citizenship. The hope is to provide some clarity and direction for community members who are curious or eager to build things that create impact for the Republic.

## Problem summary

We need robust user and project identity within the World Republic as a foundation for Citizenship.This will improve the quality of World Assembly elections, better support developers on their journey of building on the superchain and create a high trust ecosystem.
...
- Attestations issued for their own sake are at risk of being arbitrary - i.e. not representing anything meaningful for the World Republic.
...
While we are not taking an approach of building all the layers horizontally, the World Republic Foundation will support the establishment of an opinionated identity data structure that others can build around. By forming an opinion on how individuals and projects are represented in the Republic, we will make it easier for others to contribute and interoperate. Stay tuned for more updates on this.

We recommend that others keen to build within the identity and reputation space in the World Republic take an approach of solving a specific and real problem for a clearly-defined user group and consider how this relates to the various layers of the identity stack, while adopting a shared user and project identity structure.

For those seeking specific input and ideas on what the Foundation and World Assembly consider valuable work, please refer to the Builder Ideas List, and current Representative Mission Requests and Foundation Mission Requests - these are the channels where specific work is called for.
