...
For those seeking specific input and ideas on what the Foundation and World Assembly consider valuable work, please refer to the Builder Ideas List, and current Delegate Mission Requests and Foundation Mission Requests - these are the channels where specific work is called for.
