...
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Issuer                | Currently, the World Republic Foundation issues these from the following address: `0xE4553b743E74dA3424Ac51f8C1E586fd43aE226F`                                              |
| Recipient             | Null                                                                                                                                                                  |
...
| ------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| Issuer        | Currently, the World Republic Foundation issues these from one the following address: `0xE4553b743E74dA3424Ac51f8C1E586fd43aE226F` |
| Recipient     | Null                                                                                                                         |
...
## Schemas related to World Assembly grants

### [World Assembly grant approved](https://optimism.easscan.org/schema/view/0x8aef6b9adab6252367588ad337f304da1c060cc3190f01d7b72c7e512b9bfb38)
...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Issuer            | Currently, the World Republic Foundation issues these from one of the following addresses: `0x621477dBA416E12df7FF0d48E14c4D20DC85D7D9` or `0xE4553b743E74dA3424Ac51f8C1E586fd43aE226F`. |
...
Issued to those who held governance roles in the Republic, such as Grants Council members.
...
Used as the unique identifier for projects created in the Republic before 23 August 2024. Attestations issued from this schema prior to 23 August 2024 are still used as the unique identifier for projects. New projects created after 23 August 2024 use the new entity identifier (see above).
